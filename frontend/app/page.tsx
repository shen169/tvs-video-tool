    ...
    <div className="max-w-4xl mx-auto px-8 py-14">
      ...
      <header className="text-center mb-16">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          <a href="#how-it-works" className="px-6 py-3 rounded-2xl border border-[#27272c] bg-[#121214] text-zinc-400 hover:text-zinc-200 text-sm transition-all">
            了解更多 ↓
          </a>
        </div>
      </header>
      ...
      {/* How It Works */}
      {/* ═══════════════════════════════════════════════════════════ */}
      <section aria-labelledby="how-heading" className="mb-20" id="how-it-works">
