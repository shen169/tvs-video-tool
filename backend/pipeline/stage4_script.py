...
NARRATIVE = {
    ...
    "pain_point_relief": [
        ...
        ("Solution",   "medium",   d_angle,    "cut",      "Turn",
    ...
    "real_user_share": [
        ...
        ("Discovery",  "close_up", "eye_level", "cut",      "Turn",
         ...
         lambda d: d['feat1'][:35]),
        ("Usage",      "medium",   d_angle,    "cut",      "Develop",
        ...
        ("Result",     "close_up", "low_hero",  "dissolve","Escalate",
         ...
         lambda d: d['usp1'][:35]),
        ("Recommend",  "wide",     d_angle,    "fade",     "Resolve",
    ...
    "tvc_cinematic": [
        ...
        ("Detail",     "close_up", "top_down",  "cut",      "Turn",
         ...
         lambda d: f"{d['feat1']}.",
         lambda d: d['feat1'][:35]),
        ("Lifestyle",  "medium",   d_angle,    "cut",      "Develop",
    ...
    "scene_lifestyle": [
        ...
        ("InScene",    "medium",   d_angle,    "dissolve","Build",
        ...
        ("Detail",     "close_up", "45_degree", "cut",      "Turn",
         ...
         lambda d: f"{d['feat1']}.",
         lambda d: d['feat1'][:35]),
        ("Scene2",     "medium",   d_angle,    "cut",      "Develop",
    ...
    "comparison_test": [
        ("Before",     "wide",     "eye_level", "cut",     "Hook",
         ...
         lambda d: d['hook'],
         lambda d: d['hook'][:40]),
        ("OldWay",     "medium",   d_angle,    "dissolve","Build",
        ...
        ("Difference", "close_up", "low_hero",  "dissolve","Escalate",
         ...
         lambda d: d['usp1'][:35]),
        ("Verdict",    "wide",     d_angle,    "fade",     "Resolve",
    ...
    "unboxing_experience": [
        ...
        ("DetailCU",   "close_up", "top_down",  "cut",      "Turn",
         ...
         lambda d: d['feat1'][:35]),
        ("Walkthrough","medium",   d_angle,    "cut",      "Develop",
